...
export async function GET() {
  try {
    ...
    const rows = await query(
      `SELECT cc.id, cc.body_text AS bodyText, cc.created_at AS createdAt, u.display_name AS displayName, u.avatar_url AS avatarUrl, cl.title AS contentTitle, cl.slug AS contentSlug, cc.status AS status
